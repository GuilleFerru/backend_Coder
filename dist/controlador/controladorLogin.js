...
module.exports = {
    ...
    getRegister: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            res.render("login", {
    ...
    getFailRegister: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            res.render('error', {
                btnAction: '/register',
