...
exports.saveMessageToDB = exports.loadMessagesFromDB = void 0;
var mongoose_1 = __importDefault(require("mongoose"));
var mensajes_1 = require("./models/mensajes");
var MONGO_URL = 'mongodb://localhost:27017/ecommerce';
var loadMessagesFromDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var messages, savedMessages, error_1;
...
exports.loadMessagesFromDB = loadMessagesFromDB;
var saveMessageToDB = function (message) { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.sent();
                console.log("Base de datos conectada");
                return [4 /*yield*/, mensajes_1.mensajesModel.insertMany(message)];
            case 2:
                _a.sent();
                return [3 /*break*/, 6];
            case 3:
