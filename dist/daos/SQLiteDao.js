...
var optionsSQLite = {
    client: 'sqlite3',
    connection: {
        filename: './DB/SQLiteDB/ecommerce.sqlite'
    },
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        ...
                        _b = (_a = console).log;
                        return [4 /*yield*/, this.knex("carrito").join("ordenes", "carrito.orden_id", "=", "ordenes._id").join("productos", "carrito.producto_id", "=", "productos._id")];
                    case 9:
                        _b.apply(_a, [_c.sent()]);
                        return [4 /*yield*/, this.knex.from('carrito').del()];
                    case 10:
                        _c.sent();
                        return [4 /*yield*/, this.knex.from('ordenes').del()];
                    case 11:
                        _c.sent();
                        return [7 /*endfinally*/];
