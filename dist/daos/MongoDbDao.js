...
var MongoDbDao = /** @class */ (function () {
    ...
    MongoDbDao.prototype.getUsuario = function (usuario) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, usuarios_1.usuarioModel.find({}, { __v: 0, createdAt: 0, updatedAt: 0 })];
                    case 1:
                        savedUsers = _a.sent();
                        savedUsers.forEach(function (user) {
                            if (user === usuario) {
                                _this.usuarioOk = true;
                            }
                        });
                        return [3 /*break*/, 4];
                    case 2:
                    ...
                    return [2 /*return*/, this.usuarioOk];
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        _f.label = 2;
                    case 2:
                        if (!(_i < order_2.length)) return [3 /*break*/, 5];
                        carrito = order_2[_i];
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, order_1.ordenModel.insertMany({
                            productos: order,
    ...
    MongoDbDao.prototype.getMensajes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var savedMensajes, error_12, mensajes;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
